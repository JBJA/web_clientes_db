<%-- 
    Document   : index
    Created on : 30/09/2021, 13:49:52
        ...
        <div class="container">
            <form action="sr_cliente" method="post" class="form-group">
                ...
                <label for="lbl_nombres"><b>Nombres</b></label>
                  ...
                  <input type="number" name="txt_telefono" id="txt_telefono" class="form-control" placeholder="Ejemplo: 555-555 . . ." required>
                  
                  <label for="lbl_fn"><b>Nacimiento</b></label>
                  <input type="date" name="txt_fn" id="txt_fn" class="form-control" placeholder="Ejemplo: 2021/02/02 . . ." required>
